...
assert.equal(latest.url, "https://github.com/SchweppesSoda/bob-bailian-ocr/releases/download/v2.3.0/bob-bailian-ocr-2.3.0.bobplugin");
assert.equal(source.version, info.version);
assert.equal(source.commit, "9fb7e6042ed94cf263c2e08b473170cd6cd64399");
